// Run with: go run ./examples/contacts/error_handling
//
// Demonstrate the typed error tree on the contacts surface. Each subtype
...
func main() {
	...
	_, err = api.Contacts.Create(context.Background(), &contacts.CreateParams{
	...
	case errors.As(err, &conflict):
		fmt.Printf("contact already exists — code=%s\n", conflict.Code)
